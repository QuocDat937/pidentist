 ...
 *
 * Auto-update enabled:
 *   - rank-math, fluentform, wordfence, updraftplus, custom-post-type-ui
 *
 * Auto-update disabled (có thể break khi update tự động):
 *   - litespeed-cache, redis-cache, nginx-helper, wps-hide-login
 *
 * Core updates:
...
function pi_check_plugin_compliance() {
	...
	<div class="notice notice-warning is-dismissible">
		<p>
			...
			Plugin ngoài danh sách approved đang active: <code><?php echo $slugs_list; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- escaped via esc_html in array_map above. ?></code>.
